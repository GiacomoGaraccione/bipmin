...
exports.getAttempts = () => {
  return new Promise((resolve, reject) => {
    const sql = "SELECT users.name, attempts.exerciseId, attempts.attempt, attempts.mode, attempts.errors, attempts.rules, attempts.diagram, attempts.success, attempts.timestamp FROM users, attempts WHERE users.id = attempts.userId ORDER BY users.id, attempts.mode"
    db.all(sql, [], (err, rows) => {
      if (err) {
        reject(err)
      } else {
...
exports.addSizes = (username, exercise, mode, attempt, sizes) => {
  return new Promise((resolve, reject) => {
    const sql = "INSERT INTO sizes(username, exercise, mode, attempt, sizes) VALUES(?, ?, ?, ?, ?)"
    db.run(sql, [username, exercise, mode, attempt, sizes], (err) => {
      if (err) {
        reject(err)
      } else {
        resolve()
...
exports.addSyntax = (username, exercise, mode, attempt, errors, errorCount) => {
  return new Promise((resolve, reject) => {
    const sql = "INSERT INTO syntax(username, exercise, mode, attempt, errors, errorCount) VALUES(?, ?, ?, ?, ?, ?)"
    db.run(sql, [username, exercise, mode, attempt, errors, errorCount], (err) => {
      if (err) {
        reject(err)
      } else {
        resolve()
...
exports.addErrors = (username, exercise, mode, attempt, errors, checkedRules) => {
  return new Promise((resolve, reject) => {
    const sql = "INSERT INTO errors(username, exercise, mode, attempt, errors, errorCount, checkedRules, ruleCount) VALUES(?, ?, ?, ?, ?, ?, ?, ?)"
    db.run(sql, [username, exercise, mode, attempt, errors, errors.length, checkedRules, checkedRules.length], (err) => {
      if (err) {
        reject(err)
      } else {
        resolve()
...
exports.addOldErrors = (username, exercise, errors, errorCount, found, foundCount) => {
  return new Promise((resolve, reject) => {
    const sql = "INSERT INTO old_errors(username, exercise, errors, errorCount, found, foundCount) VALUES(?, ?, ?, ?, ?, ?)"
    db.run(sql, [username, exercise, errors, errorCount, found, foundCount], (err) => {
      if (err) {
        reject(err)
      } else {
        resolve()
